    ...
    <div class="flex h-screen">
        ...
        <aside class="w-72 bg-gray-900 text-white p-6 flex flex-col justify-between shadow-lg">
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ route('dashboard') }}" class="block py-2 px-4 rounded-lg bg-gray-800 text-white hover:bg-indigo-600 nav-hover">Dashboard</a></li>
                    <li><a href="{{ route('cars.index') }}" class="block py-2 px-4 rounded-lg bg-gray-800 text-white hover:bg-indigo-600 nav-hover">Manage Cars</a></li>
                    <li><a href="{{ route('admin.bookings') }}" class="block py-2 px-4 rounded-lg bg-gray-800 text-white hover:bg-indigo-600 nav-hover">Rentals</a></li>
                </ul>
            </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <nav class="bg-white shadow-md p-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('admin.logout') }}" class="bg-indigo-500 text-white py-2 px-5 rounded-lg hover:bg-indigo-600 transition">Logout</a>
                </div>
            </nav>
