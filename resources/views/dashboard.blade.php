                ...
                <div class="col-12 col-md-4">
                    <div class="card bg-primary text-white shadow-lg border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a href="{{ route('cars.index') }}" class="btn btn-light text-primary btn-lg mt-auto">Go to Cars</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="card bg-success text-white shadow-lg border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a href="{{ route('admin.bookings') }}" class="btn btn-light text-success btn-lg mt-auto">Go to Bookings</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="card bg-warning text-white shadow-lg border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a href="{{ route('cars.create') }}" class="btn btn-light text-warning btn-lg mt-auto">Add Car</a>
                        </div>
                    </div>
                </div>
            </div>
